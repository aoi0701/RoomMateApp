  ...
  Future<void> _handleResetPassword() async {
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Đã gửi email reset. Kiểm tra hộp thư/spam.',
          ),
        ),
      );
      Navigator.push(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(vm.errorMessage ?? 'Gửi email thất bại'),
        ),
      );
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Nhập email đã đăng ký để nhận liên kết đặt lại mật khẩu từ Firebase.',
                  ...
                  child: Column(
                    children: [
                      ...
                      AppPrimaryButton(
                        ...
                        onTap: vm.isLoading ? null : _handleResetPassword,
                      ),
                    ],
                  ),
                ),
